...
This directory contains editable SVG figures and compact source tables used in the manuscript.

- The top-level `figures/` and `source_data/` directories contain the main composite figures and their source tables.
